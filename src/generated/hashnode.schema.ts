...
export type GetArticlesQuery = {
  ...
  user?: {
    ...
    posts: {
      ...
      pageInfo: { __typename?: 'OffsetPageInfo'; hasNextPage?: boolean | null }
    }
  } | null
}
...
export function useGetArticleBySlugQuery(
  ...
  > &
    (
      | { variables: GetArticleBySlugQueryVariables; skip?: boolean }
      | { skip: boolean }
    )
) {
...
export function useGetArticleBySlugSuspenseQuery(
...
>
export type GetArticleBySlugSuspenseQueryHookResult = ReturnType<
  typeof useGetArticleBySlugSuspenseQuery
>
