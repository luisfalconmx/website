...
export default function PrivacyPolicyPage() {
  return (
    <main
      className={cn(
        'mx-auto my-12 mb-16 max-w-screen-xl gap-x-6 md:px-8 lg:my-16 lg:px-16',
        styles['post']
      )}
    >
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Webview Inspector, the
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Webview Inspector.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://www.luisfalconmx.dev/contact"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://www.luisfalconmx.dev/contact
          </a>
        </li>
      </ul>
    </main>
