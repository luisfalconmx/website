...
const CardCertification = ({
  ...
  <div className="flex w-full flex-col rounded-b-xl rounded-t-xl border border-iron/40 bg-onyx">
    <Image
      src={image}
      alt={name}
      width="720"
    ...
    <div className="flex h-full flex-col border border-l-0 border-onyx/30 px-8 py-10">
      ...
      <p className="mb-6 block text-smoke">{humanDate(date)}</p>

      <b className="text-lg">Certification ID</b>
      <p className="mb-6 max-w-full overflow-clip text-smoke">{credentialId}</p>
